      ...
      <form action="{{ route('user.postUpdateUser') }}" method="POST">
        ...
        <tbody>
          ...
          <tr>
            <td>Line</td>
            <td>
              <input type="text" placeholder="Line" id="line" class="form-control" name="line" value="{{ $user->line }}" required autofocus>
            </td>
          </tr>
          <tr>
            <td>GitHub</td>
            <td>
              <input type="text" placeholder="GitHub" id="github" class="form-control" name="github" value="{{ $user->github }}" required autofocus>
            </td>
          </tr>
          <tr class="pt-4">
            <td></td>
